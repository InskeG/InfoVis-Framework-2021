...
export default Kapsule({
    props: {
        ...
        showGroupTooltip: {default: true},
        showLineTooltip: {default: true},
    ...
    init(el, state) {
        ...
        function buildDomStructure() {
            ...
            state.colorLegend = ColorLegend().onLegendClick(state.onLegendClick)(state.svg.append('g')
                .attr('class', 'legendG')
                .node());
        ...
        function renderTimelines(maxElems) {
            ...
            newSegments
                .on('mouseover', function (d) {
                    if (('disableHover' in state && state.disableHover) || d.target.classList.contains('disabled'))
                        return;
